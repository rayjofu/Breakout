...
int combobonus;
int paddle2_speed;
Texture red_brick_texture;
Texture green_brick_texture;
Texture yellow_brick_texture;
...
int main()
{
	...
	// setup bricks
	if (!cracks_texture.loadFromFile("yellow_brick_damaged.png")) {
		cout << "File 'yellow_brick_damaged.png' not found!" << endl;
	}
	if (!cracks_texture2.loadFromFile("yellow_brick_damaged2.png")) {
		cout << "File 'yellow_brick_damaged2.png' not found!" << endl;
	}
	if (!red_brick_texture.loadFromFile("red_brick.png")) {
		cout << "File 'red_brick.png' not found!" << endl;
	}
	if (!green_brick_texture.loadFromFile("green_brick.png")) {
		cout << "File 'green_brick.png' not found!" << endl;
	}
	if (!yellow_brick_texture.loadFromFile("yellow_brick.png")) {
		cout << "File 'yellow_brick.png' not found!" << endl;
	}
	load_bricks();
...
//				bricks[i * 10 + j].setFillColor(Color::Red);
				bricks[i * 10 + j].setTexture(&red_brick_texture);
				bricks[i * 10 + j].setType(random);
			}
			else if (random == 2) {
//				bricks[i * 10 + j].setFillColor(Color::Yellow);
				bricks[i * 10 + j].setTexture(&yellow_brick_texture);
				bricks[i * 10 + j].setType(random);
			}
			else if (random == 3) {
...
//				bricks[i * 10 + j].setFillColor(Color::Green);
				bricks[i * 10 + j].setTexture(&green_brick_texture);
				bricks[i * 10 + j].setType(random);
			}
		}
	}
